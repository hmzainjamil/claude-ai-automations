...
> 8,159 n8n workflows + MAE automation engine — every business process automated. Email, CRM, Slack, Shopify, social, data, reporting, lead gen, and more.
...
|---|---|---|
| [Core System](bin/) | `bin/` | All automation scripts for claude-ai-automations — MAE integrated |
